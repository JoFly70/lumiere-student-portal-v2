-- Lumiere Student Portal - FRESH RESET
-- This completely resets the database and creates everything clean
-- WARNING: This deletes existing data! Safe since you're just setting up.
...
SELECT 
  '✅ Fresh database created!' as status,
